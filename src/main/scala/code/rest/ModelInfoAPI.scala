...
object ModelInfoAPI extends RestHelper {
  ...
  def init(): Unit = {
    ...
    APIs.insertBoot("/modelinfo/search")
    APIs.insertBoot("/modelinfo/factor")
    APIs.insertBoot("/modelinfo/getall")
    APIs.insertBoot("/modelinfo/getbymodelinfoid")
    APIs.insertBoot("/modelinfo/getbymodelinfostatus")
    APIs.insertBoot("/modelinfo/getbyfactoroptionid")
    APIs.insertBoot("/modelinfo/update")
    APIs.insertBoot("/modelinfo/delete")
    APIs.insertBoot("/modelinfo/insert")
    APIs.insertBoot("/modelinfo/view")
    APIs.insertBoot("/modelinfo/range")
    APIs.insertBoot("/modelinfo/rangeandupdate")
    APIs.insertBoot("/modelinfo/copymodel")
    APIs.insertBoot("/modelinfo/delall")
